...
export function FlippingCard({ card, small = false, highlight = false, delay = 0 }) {
  ...
  return (
    <div className={`${w} relative`} style={{ perspective: '600px' }}>
      <motion.div
      ...
      >
        {/* Back face */}
        <div
          className="absolute inset-0 rounded-xl bg-blue-900 border-2 border-blue-500 flex items-center justify-center"
        ...
        {/* Front face */}
        <div
          className={`absolute inset-0 rounded-xl shadow-md bg-white ${border} flex flex-col`}
